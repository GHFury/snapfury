...
export default function SignInPage() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(false);
    if (res?.error) { setError("Invalid email or password. Try again!"); return; }
    ...
    <div style={{ fontFamily: "'Special Elite',serif", background: "#f0e6c8", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .snap-input { width: 100%; border: 3px solid #111; background: #fdf8ec; font-family: 'Special Elite', serif; font-size: 1rem; padding: 12px 14px; outline: none; box-shadow: 3px 3px 0 #111; transition: box-shadow 0.1s, transform 0.1s; color: #111; }
      ...
      <div style={{ borderBottom: "5px solid #111" }}>
        ...
        <div style={{ padding: "10px 32px 8px", textAlign: "center", background: "white", borderBottom: "3px solid #111", position: "relative" }}>
          ...
          <div style={{ fontFamily: "'Special Elite',serif", fontSize: "0.75rem", letterSpacing: 3, color: "#555" }}>"YOUR IDENTITY AWAITS" · ALL THE SNAPS FIT TO PRINT</div>
        </div>
        <div style={{ background: "#8B2035", padding: "7px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "3px solid #111" }}>
          <span className="spidey" style={{ color: "white", fontSize: "0.95rem" }}>SECURE IDENTITY VERIFICATION REQUIRED</span>
      ...
      {/* MAIN */}
      <div className="newsprint" style={{ flex: 1, padding: "40px 24px", display: "flex", justifyContent: "center", alignItems: "flex-start" }}>
        <div style={{ width: "100%", maxWidth: 980, display: "grid", gridTemplateColumns: "1fr 400px", gap: 32, alignItems: "start" }}>

          {/* LEFT PROMO PANEL */}
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div className="panel pop-in" style={{ background: "#4A3DC8", transform: "rotate(-1deg)" }}>
              ...
              <div style={{ background: "#C8952A", borderBottom: "4px solid #111", padding: "7px 16px", display: "flex", justifyContent: "space-between", position: "relative", zIndex: 2 }}>
                <span className="spidey" style={{ color: "#111", fontSize: "0.95rem" }}>EXCLUSIVE MEMBER ACCESS</span>
              ...
              <div style={{ padding: "28px 24px", position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
                ...
                <div style={{ textAlign: "center" }}>
                  <div className="spidey-lg" style={{ fontSize: "3.2rem", color: "#C8952A", display: "block" }}>WELCOME</div>
                  <div className="spidey-lg" style={{ fontSize: "3.2rem", color: "white", display: "block" }}>BACK!</div>
                </div>
                <p style={{ fontFamily: "'Special Elite',serif", color: "rgba(255,255,255,0.85)", fontSize: "0.9rem", textAlign: "center", lineHeight: 1.7, maxWidth: 260 }}>
                  Your snaps are waiting. Sign in and get back to the fury.
                </p>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              {[
                ...
                { label: "CLIPS UPLOADED",     val: "10,000+", tag: "POW!", tc: "#8B2035", rot: "1deg" },
              ].map(s => (
            ...
            <div className="panel" style={{ overflow: "hidden", transform: "rotate(0.5deg)" }}>
              ...
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(90deg,rgba(74,61,200,0.7) 0%,transparent 50%)", display: "flex", alignItems: "center", padding: "0 20px" }}>
                <div>
                  <div className="spidey" style={{ color: "#C8952A", fontSize: "1.4rem", display: "block" }}>THE FURY NEVER STOPS.</div>
                  <div style={{ fontFamily: "'Special Elite',serif", color: "white", fontSize: "0.8rem", marginTop: 4 }}>@FuryMSnap · YouTube</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", marginBottom: -4, position: "relative", zIndex: 5 }}>
              <div style={{ fontFamily: "'Anton',sans-serif", fontStyle: "italic", fontSize: "1.2rem", letterSpacing: 2, padding: "10px 28px", flex: 1, textAlign: "center", background: "#4A3DC8", color: "white", border: "3px solid #111", borderBottom: "none", boxShadow: "4px 0 0 #111", transform: "translate(-2px,-2px)", zIndex: 2 }}>
                SIGN IN
              </div>
              <Link href="/signup" style={{ fontFamily: "'Anton',sans-serif", fontStyle: "italic", fontSize: "1.2rem", letterSpacing: 2, padding: "10px 28px", flex: 1, textAlign: "center", background: "#f0e6c8", color: "#555", border: "3px solid #111", borderLeft: "2px solid #111", borderBottom: "3px solid #111", textDecoration: "none", display: "block" }}>
                JOIN FURY
              </Link>
            </div>
            ...
            <div className="panel" style={{ background: "white", position: "relative", zIndex: 3 }}>
              <div style={{ background: "#4A3DC8", borderBottom: "4px solid #111", padding: "10px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span className="spidey" style={{ color: "white", fontSize: "1.1rem" }}>★ SECRET IDENTITY CHECK ★</span>
                <span style={{ fontFamily: "'Special Elite',serif", fontSize: "0.75rem", color: "rgba(255,255,255,0.7)", letterSpacing: 2 }}>VERIFIED</span>
              </div>

              <div style={{ padding: "24px" }}>
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  <div className="spidey-lg" style={{ fontSize: "2.2rem", color: "#4A3DC8", display: "block" }}>SNAP IN!</div>
                  <div style={{ fontFamily: "'Special Elite',serif", fontSize: "0.8rem", color: "#888", letterSpacing: 2, marginTop: 6 }}>Confirm your secret identity</div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      <input className="snap-input" type={showPass ? "text" : "password"} placeholder="••••••••"
                    ...
                    <div style={{ textAlign: "right", marginTop: 6 }}>
                      <span style={{ fontFamily: "'Special Elite',serif", fontSize: "0.8rem", color: "#4A3DC8", cursor: "pointer", textDecoration: "underline" }}>Forgot password?</span>
                    </div>
                  </div>
                </div>

                <button className="btn pulse" onClick={handleSubmit} disabled={loading}
                  style={{ width: "100%", marginTop: 20, background: "#4A3DC8", color: "white", padding: 14, fontSize: "1.5rem", boxShadow: "5px 5px 0 #111", borderRadius: 3 }}>
                  {loading ? "CHECKING..." : "⚡ SNAP IN"}
                </button>

                <div style={{ textAlign: "center", marginTop: 16, borderTop: "2px dashed #ddd", paddingTop: 14 }}>
                  <span style={{ fontFamily: "'Special Elite',serif", fontSize: "0.85rem", color: "#666" }}>New to SnapFury? </span>
                  <Link href="/signup" style={{ fontFamily: "'Anton',sans-serif", fontStyle: "italic", color: "#8B2035", fontSize: "0.95rem", letterSpacing: 1, marginLeft: 4, textDecoration: "none" }}>
                    JOIN THE FURY →
                  </Link>
                </div>
              </div>
            ...
            <p style={{ fontFamily: "'Special Elite',serif", fontSize: "0.72rem", color: "#888", lineHeight: 1.6, textAlign: "center", marginTop: 12 }}>
              By signing in, you agree to SnapFury's Terms of Service and Privacy Policy.<br />
